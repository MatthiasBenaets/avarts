  ...
  <div class="mt-12 bg-neutral-800">
    ...
    <div class="pb-4 border-b border-neutral-500">
      <ul class="flex flex-wrap mt-5">
        <li class="flex flex-col w-1/3 mx-auto text-center border-e border-neutral-500">
          <span class="text-neutral-500">Following</span>
          <span class="text-xl text-white hover:text-orange-500">
            <a href="/">
              41
            </a>
          </span>
        ...
        <li class="flex flex-col w-1/3 mx-auto text-center">
    ...
    <div class="flex flex-col mt-8 px-4 text-white">
      ...
      <div class="pb-5 border-b border-neutral-500 hover:text-orange-500">
        <span class="text-md font-semibold"><a href="/">training log <span class="text-sm font-normal">- date</span></a></span>
      </div>
    </div>
    <div class="my-4 px-4">
