  ...
  <div class="px-5 pt-6 pb-3 border-b border-neutral-500 w-full">
    <ul class="flex flex-wrap text-white w-fit border bg-neutral-800 rounded-md overflow-hidden">
      <button class="flex" on:click={() => activityType = "cycling"}>
        <li class="p-2 border-e border-neutral-500 {activityType != 'cycling' ? 'hover:text-orange-500' : 'bg-neutral-700 text-orange-500'}">
      ...
      <button class="flex" on:click={() => activityType = "running"}>
        <li class="p-2 border-e border-neutral-500 {activityType != 'running' ? 'hover:text-orange-500' : 'bg-neutral-700 text-orange-500'}">
      ...
      <button class="flex" on:click={() => activityType = "swimming"}>
        <li class="p-2 {activityType != 'swimming' ? 'hover:text-orange-500' : 'bg-neutral-700 text-orange-500'}">
